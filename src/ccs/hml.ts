...
module HML {
    ...
    export class StrongExistsFormula implements Formula {
        private hmlStr: string;
        constructor(
            public actionMatcher: ActionMatcher,
    ...
    export class DiamondFormula implements Formula {
        constructor(
            public relational_operator: string,
        ...
        newMinFixedPoint(variable: string, subFormula: Formula) {
            ...
            if (this.formulaByName(variable)) {
                this.errors.push({
                    ...
                    message: "The variable '" + variable + "' is defined multiple times."
                });
            } else {
        ...
        getErrors(): string[] {
            ...
            this.undefinedVariables.forEach((variable) => {
                errors.push({
                    ...
                    message: "The variable '" + variable + "' has not been defined."
                });
            });
            if (errors.length === 0) {
        ...
        check(formulaSet: FormulaSet) {
            ...
            variables.forEach((variable) => {
                if (formulaSet.formulaByName(variable).dispatchOn(this)) {
                    errors.push({
                        name: 'NonAcyclicVariable',
                        message: "The variable '" + variable + "' is not acyclic"
                    });
                }
            });
