module Activity {
    var Tooltips = {
        ...
        'collapse-tccs-strong-timed':
            'Collapse all processes that are strongly timed bisimilar (∼<sub>t</sub>) into a single process.',
        'collapse-tccs-strong-untimed':
            'Collapse all processes that are strongly untimed bisimilar (∼<sub>u</sub>) into a single process.',
        'collapse-tccs-weak-timed':
            'Collapse all processes that are weakly timed bisimilar (≈<sub>t</sub>) into a single process.',
        'collapse-tccs-weak-untimed':
            'Collapse all processes that are weakly untimed bisimilar (≈<sub>u</sub>) into a single process.',
    ...
    export class Tooltip {
        ...
        constructor($container: JQuery, titleFunction: Function, selectorClass: string) {
            ...
            this.$container.tooltip({
                title: function () {
                    return titleFunction(thisTooltip, this);
                },
        ...
        static strongSequence(
            abstractingSuccGen: Traverse.AbstractingSuccessorGenerator,
            source: CCS.Process,
            action: CCS.Action,
            target: CCS.Process,
            graph = null
